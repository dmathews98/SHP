...
def main():
    ...
    # Initialise
    MSDs1 = MSD(FileName2, check)
    MSDs1.parsL()
    MSDs1.parsInitPos()
    MSDs1.parsPos()

    MSDs2 = MSD(FileName2, check)
    MSDs2.parsL()
    MSDs2.parsInitPos()
    MSDs2.parsPos()

    MSDs3 = MSD(FileName3, check)
    MSDs3.parsL()
    MSDs3.parsInitPos()
    MSDs3.parsPos()
    ...
    # Plotting
    plt.plot(MSDs_norm[0], 'r')
    plt.plot(MSDs_norm[1], 'b')
    plt.plot(MSDs_norm[2], 'g')
    plt.legend(['Mg', 'O', 'H'], loc = 'upper left')
    plt.ylabel('MSD /Angstrom^2')
    plt.xlabel('Time /0.5fs')
    plt.title('MSD MD')
    plt.savefig('MSD-overall.png')

    plt.plot(MSDs1_norm[0], 'r')
    plt.plot(MSDs1_norm[1], 'b')
    plt.plot(MSDs1_norm[2], 'g')
    plt.legend(['Mg', 'O', 'H'], loc = 'upper left')
    plt.ylabel('MSD /Angstrom^2')
    plt.xlabel('Time /0.5fs')
    plt.title('MSD MD')
    plt.savefig('MSD-1.png')

    plt.plot(MSDs2_norm[0], 'r')
    plt.plot(MSDs2_norm[1], 'b')
    plt.plot(MSDs2_norm[2], 'g')
    plt.legend(['Mg', 'O', 'H'], loc = 'upper left')
    plt.ylabel('MSD /Angstrom^2')
    plt.xlabel('Time /0.5fs')
    plt.title('MSD MD')
    plt.savefig('MSD-2.png')

    plt.plot(MSDs3_norm[0], 'r')
    plt.plot(MSDs3_norm[1], 'b')
    plt.plot(MSDs3_norm[2], 'g')
    plt.legend(['Mg', 'O', 'H'], loc = 'upper left')
    plt.ylabel('MSD /Angstrom^2')
    plt.xlabel('Time /0.5fs')
    plt.title('MSD MD')
    plt.savefig('MSD-3.png')
